    ...
    await expect(
      runWithSessionProcessOwner(owner!, () =>
        runClaudeSubprocess({
          ...
          noninteractive: true,
          terminalInput: false,
          label: 'claude-startup-exit',
          processLabel: 'Claude agent (claude-startup-exit)' as AgentProcessLabel,
          extraArgs: ['--fixture-exit-before-read'],
          processFormattedMessages: (): void => {},
        })
      )
