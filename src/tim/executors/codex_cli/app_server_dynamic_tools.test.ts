...
describe('Codex dynamic-tool transport contracts', () => {
  ...
  test.each([
    ['missing thread ID', { turnId: 'turn', callId: 'call', tool: 'ListTimAgents', arguments: {} }],
    [
      'missing turn ID',
      { threadId: 'thread', callId: 'call', tool: 'ListTimAgents', arguments: {} },
    ],
    [
      'missing call ID',
      { threadId: 'thread', turnId: 'turn', tool: 'ListTimAgents', arguments: {} },
    ],
    [
      'empty thread ID',
      { threadId: '', turnId: 'turn', callId: 'call', tool: 'ListTimAgents', arguments: {} },
    ],
    [
      'empty turn ID',
      { threadId: 'thread', turnId: '', callId: 'call', tool: 'ListTimAgents', arguments: {} },
    ],
    [
      'empty call ID',
      { threadId: 'thread', turnId: 'turn', callId: '', tool: 'ListTimAgents', arguments: {} },
    ],
    ...
    [
      'missing arguments',
      { threadId: 'thread', turnId: 'turn', callId: 'call', tool: 'ListTimAgents' },
    ],
    [
      'invalid namespace',
      {
