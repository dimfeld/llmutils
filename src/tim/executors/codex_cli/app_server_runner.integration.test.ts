...
function createProvider(role: AgentIdentity['role']): CodexDynamicToolProvider {
  const dispatcher: CodexAgentToolDispatcher = {
    startAgent: async () => {
      throw new Error('StartTimAgent is not part of this integration call.');
    },
    listAgents: () => ({ agents: [] }),
    sendAgentMessage: async () => {
      throw new Error('SendTimAgentMessage is not part of this integration call.');
    },
    stopAgent: async () => {
      throw new Error('StopTimAgent is not part of this integration call.');
    },
    finishAgent: async () => {
      throw new Error('FinishTimAgent is not part of this integration call.');
    },
  };
