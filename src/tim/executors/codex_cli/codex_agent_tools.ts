...
function formatArgumentFailure(
  ...
  if (Object.hasOwn(value, 'target') && toolName === 'FinishTimAgent') {
    return 'Arguments for FinishTimAgent are invalid: FinishTimAgent does not accept a target.';
  }
