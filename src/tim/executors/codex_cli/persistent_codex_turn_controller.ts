...
export class PersistentCodexTurnController {
  ...
  private handleNotification(method: string, params: unknown): void {
    ...
    if (method === 'turn/started') {
      if (turn !== undefined && !turn.settled && notification.turnId !== undefined) {
      ...
      if (this.forcedShutdownRequested) {
        if (turn !== undefined) void this.interruptTurn(turn);
  ...
  private deliver(message: AgentInputMessage): Promise<AgentInputDelivery> {
    ...
    return this.attemptDelivery(message.content, { kind: 'ordinary' }).finally(() => {
