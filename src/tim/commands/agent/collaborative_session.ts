...
import {
  createAgentEnvironmentIdentity,
  type OrchestratorEnvironmentIdentity,
...
export class CollaborativeAgentSession {
  ...
  private constructor(
    ...
    orchestratorEnvironmentIdentity: OrchestratorEnvironmentIdentity
  ) {
    ...
    this.orchestratorEnvironmentIdentity = orchestratorEnvironmentIdentity;
  }
  ...
  public static async create(
    ...
    try {
      ...
      const claudeLauncherOptions: ClaudeAgentLauncherOptions = {
        ...
        messagingDirectory: manager.sessionRuntime.runtime.rootPath,
      };
      ...
      const orchestratorEnvironmentIdentity = createAgentEnvironmentIdentity(
        manager.sessionRuntime.runtime.rootPath,
