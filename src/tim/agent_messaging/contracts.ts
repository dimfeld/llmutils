...
/** A custom name accepted by StartTimAgent and StopTimAgent. */
...
export const AGENT_ARGUMENT_SCHEMAS = {
  StartTimAgent: startAgentArgumentsSchema,
  ListTimAgents: listAgentsArgumentsSchema,
  SendTimAgentMessage: sendAgentMessageArgumentsSchema,
  StopTimAgent: stopAgentArgumentsSchema,
  FinishTimAgent: finishAgentArgumentsSchema,
} as const;
