...
describe('agent messaging tool argument contracts', () => {
  test('validates StartAgent arguments and rejects model-supplied identity fields', () => {
    const args = {
      name: 'api-worker',
      type: 'implementer',
  ...
  test('validates SendAgentMessage arguments without a source field', () => {
  ...
  test('validates StopAgent arguments without caller authorization fields', () => {
  ...
  test('validates self-only FinishAgent arguments without a target', () => {
...
describe('agent messaging tool result contracts', () => {
  test('validates StartAgent and SendAgentMessage results', () => {
    expect(
  ...
  test('validates the role-discriminated ListAgents result', () => {
    const result = {
      agents: [
        {
          name: ORCHESTRATOR_AGENT_NAME,
  ...
  test('validates StopAgent and FinishAgent results', () => {
    expect(
