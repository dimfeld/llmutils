 ...
 * This is used by the `tim generate` command when using any executor.
 ...
 * 3. Use `tim tools update-plan-tasks` CLI command to add tasks
 */
...
- Use the \`tim add "Plan Title" --parent ${parentPlanId !== undefined ? parentPlanId : '<parent-plan-id>'} --priority <priority> --details "..."\` command (see the using-tim skill)
