...
const RUN_OS_PROCESS_TESTS = process.env.TEST_OS_PROCESS === '1';
...
describe.skipIf(process.platform === 'win32' || !HAS_BASH || !RUN_OS_PROCESS_TESTS)(
    ...
    test('kills a real hung descendant process', { timeout: 20_000 }, async () => {
      ...
      try {
        sleepPid = await waitFor(() => {
          ...
          const descendants = findDescendantProcesses(parent.pid, processes);
