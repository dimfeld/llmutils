...
export async function rmplanAgent(planFile: string, options: any, globalCliOptions: any) {
  ...
  if (needsPreparation) {
    ...
    // If the plan was generated by the agent, we don't need detailed steps
    // since they tend to just repeat what the task descriptions says
    planData.generatedBy !== 'agent'
  ) {
