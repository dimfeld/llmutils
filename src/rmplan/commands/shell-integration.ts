// Command handler for 'rmplan shell-integration'
...
export function generateShellFunction(shell: ShellType): string {
  ...
  return `${shellComment} function for rmplan workspace switching
# Add this to your ~/.${shell}rc or source it from a file
#
# Usage:
#   rmplan_ws          - Interactive workspace selection
#   rmplan_ws <query>  - Pre-filter workspaces matching query
