...
test('runPlanContextWithExecutor - successful execution', async () => {
  ...
  // Execute
  await runPlanContextWithExecutor(executorName, contextContent, commonOpts, rmplanConfig);
...
test('runPlanContextWithExecutor - buildExecutorAndLog throws error', async () => {
  ...
  // Execute and verify
  await expect(
    runPlanContextWithExecutor(executorName, contextContent, commonOpts, rmplanConfig)
