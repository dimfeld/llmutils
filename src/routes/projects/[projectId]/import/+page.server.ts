...
import { getImportBasePlanCandidates, getIssueTrackerStatus } from '$lib/server/issue_import.js';
...
export const load: PageServerLoad = async ({ parent, url }) => {
  ...
  return {
    ...
    basePlanCandidates: await getImportBasePlanCandidates(numericProjectId),
  };
};
