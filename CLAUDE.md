...
- **Agent manager** (orchestrator authorization, naming, capacity, StartAgent/ListAgents/SendAgentMessage) → `docs/agent-manager.md`
...
- **CI check classification, Actions logs, and `tim pr fix-ci`** → `docs/ci-check-logs.md`
