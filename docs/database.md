...
| `review_requested`    | `handlePullRequestEvent`             | `action: review_requested`; `actor` is the **requested reviewer**, not the sender                                                   |
