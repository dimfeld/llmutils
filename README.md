...
- **Plan browsing**: Dedicated Plans tab with full status filter chips (pending, in-progress, blocked, recently done, done, cancelled, deferred), reset/all controls, and comprehensive plan list for any project. Data auto-refreshes while either tab is active.
