...
In the web UI, select **Autoreview** beside a PR in a plan’s linked PR list, or on the PR detail page. This reviews that PR branch against its base, including when the plan has multiple stacked PRs.
